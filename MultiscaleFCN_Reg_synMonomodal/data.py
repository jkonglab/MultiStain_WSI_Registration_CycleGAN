...
class MNISTDataHandler(object):
  ...
  def _get_data(self):
    ...
    dataset_name = '../Dl_Model_Perf_TestSet/Syn_modCycleGAN' #'../Reg_Dataset_Breast_syn_modCycleGAN_all_patches_1024to256_set2'  #'../Dl_Model_Perf_TestSet/Syn_modCycleGAN' #'../Reg_Dataset_Breast_syn_modCycleGAN_all_patches_1024to256_set2' #'Final_Dataset_syn' #'Dataset_256_10x_Grayscale'   #'Dataset_256_10x_Grayscale_syn_test'  #'Dataset_512_10x_Grayscale'   #'sirius_data_patchwise_512'
    ...
    name_fixed1 = [i.replace('../Dl_Model_Perf_TestSet/Syn_modCycleGAN/Fixed/','') for i in fixed_images_fns]
