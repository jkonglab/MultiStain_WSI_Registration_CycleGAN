...
tf.flags.DEFINE_string('XtoY_model', 'HE2Ki67.pb', 'XtoY model name, default: HE2Ki67.pb')
tf.flags.DEFINE_string('YtoX_model', 'Ki672HE.pb', 'YtoX model name, default: Ki672HE.pb')
