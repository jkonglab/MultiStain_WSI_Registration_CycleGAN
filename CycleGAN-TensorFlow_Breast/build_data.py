...
tf.flags.DEFINE_string('X_input_dir', 'data/HE2Ki67/trainA',
                       'X input directory, default: data/HE2Ki67/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'data/HE2Ki67/trainB',
                       'Y input directory, default: data/HE2Ki67/trainB')
tf.flags.DEFINE_string('X_output_file', 'data/tfrecords/HE.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/HE.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'data/tfrecords/Ki67.tfrecords',
                       'Y output tfrecords file, default: data/tfrecords/Ki67.tfrecords')
