...
class MNISTDataHandler(object):
  ...
  def _get_data(self):
    ...
    dataset_name = '../Dl_Model_Perf_TestSet/Syn_modCycleGAN' #'../Dl_Model_Perf_TestSet/Syn_modCycleGAN' #'../Final_Dataset_syn_modCycleGAN'  #'../Dl_Model_Perf_TestSet/Syn_modCycleGAN' #'../Final_Dataset_syn_modCycleGAN'  #'Final_Dataset_syn' #'Dataset_256_10x_Grayscale'   #'Dataset_256_10x_Grayscale_syn_test'  #'Dataset_512_10x_Grayscale'   #'sirius_data_patchwise_512'
