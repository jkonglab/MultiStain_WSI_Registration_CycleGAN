...
class MNISTDataHandler(object):
  ...
  def _get_data(self):
    ...
    dataset_name = '../Dl_Model_Perf_TestSet/Syn_modCycleGAN'  #'../Reg_Dataset_Breast_syn_modCycleGAN_ROI_patches_casewise_resized/rigid_CASE69_HES_110442_76213' #'../Final_Dataset_syn_modCycleGAN'   #'../Dl_Model_Perf_TestSet/Syn_modCycleGAN'  #'../Final_Dataset_syn_modCycleGAN'   #'Dataset_256_10x_Grayscale'   #'sirius_data_patchwise_512'
