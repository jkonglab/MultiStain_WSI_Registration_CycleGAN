...
class MNISTDataHandler(object):
  ...
  def _get_data(self):
    ...
    dataset_name = '../Dl_Model_Perf_TestSet/Syn_origCycleGAN'  #'../Final_Dataset_syn_origCycleGAN' #'../Dl_Model_Perf_TestSet/Syn_origCycleGAN' #'../Final_Dataset_syn_origCycleGAN' #'../Dl_Model_Perf_TestSet/Syn_origCycleGAN'  #'../Final_Dataset_syn_modCycleGAN'   #'Dataset_256_10x_Grayscale'   #'sirius_data_patchwise_512'
    ...
    name_fixed1 = [i.replace('../Dl_Model_Perf_TestSet/Syn_origCycleGAN/Fixed/','') for i in fixed_images_fns]
